...
<div class="data_list">
    ...
    <button style="padding-bottom: 0;margin-bottom: 0;float: left" class="btn btn-success" type="button" style="margin-right: 50px;" onclick="javascript:window.location='${pageContext.request.contextPath}/absence/preAdd?student_id=null&&pageStartIndex=${pageStartIndex}'">添加</button>

    <form class="form-search" action="${pageContext.request.contextPath}/absence/compound?pageStartIndex=${pageStartIndex}&&pagenum=${page.pagenum}" method="post" style="float: right" onsubmit="return checkForm()" >
        <span> 指定日期:</span>
        ...
        <table class="table table-hover table-striped table-bordered">
            ...
            <c:forEach  varStatus="i" var="c" items="${contactorList}">
                <tr>
                    ...
                    <td>${c.leave_if}</td>
                    <td>${c.cause}</td>
                    <td><button class="btn btn-mini btn-info" type="button" onclick="javascript:window.location='${pageContext.request.contextPath}/absence/preAdd?student_id=${c.student_id}&&pageStartIndex=${pageStartIndex}'">修改</button>&nbsp;
    ...
    <div class="pagination pagination-centered">
        <ul style="margin-left: 180px;" class="pagination pagination-lg">
            <li><a href="${pageContext.request.contextPath}/absence/querystudent?pagenum=1">首页</a></li>
            <c:choose>
                <c:when test="${page.pagenum== 1 }">
                    <li><a href="#">上一页</a></li>
                </c:when>
                <c:otherwise>
                    <li><a href="${pageContext.request.contextPath}/absence/querystudent?pagenum=${page.pagenum-1}">上一页</a></li>
                </c:otherwise>
            </c:choose>

            <li><a href="${pageContext.request.contextPath}/absence/querystudent?pagenum=1">1</a></li>
            <li><a href="${pageContext.request.contextPath}/absence/querystudent?pagenum=2">2</a></li>
            <li><a href="${pageContext.request.contextPath}/absence/querystudent?pagenum=3">3</a></li>
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <li><a href="${pageContext.request.contextPath}/absence/querystudent?pagenum=${page.pagenum+1}">下一页</a></li>
                </c:otherwise>
            </c:choose>

            <li><a href="${pageContext.request.contextPath}/absence/querystudent?pagenum=${page.totalPages}">尾页</a></li>
            <li style="margin-left: 50px;"><a href="#" style="color: #0e90d2">当前页 ${page.pagenum}</a></li>
            <li><a href="#">总页数 ${page.totalPages}</a></li>
        </ul>
        <form class="form-search" action="${pageContext.request.contextPath}/absence/querystudent" method="post" style="float: right" onsubmit="return pageNumCheck()">
