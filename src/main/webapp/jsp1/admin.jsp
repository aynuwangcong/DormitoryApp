    ...
    <div class="row-fluid">
        <div class="bs-docs-sidebar" >
            <ul class="bs-docs-sidenav">
                ...
                <li><a href="${pageContext.request.contextPath}/manage/querystudent">宿舍管理员管理<i class="aa fa fa-chevron-right" aria-hidden="true"></i></a></li>
                <li><a href="${pageContext.request.contextPath}/student/querystudent">学生信息管理<i class="aa fa fa-chevron-right" aria-hidden="true"></i></a></li>
                <li><a href="${pageContext.request.contextPath}/build/querystudent">宿舍楼信息管理<i class="aa fa fa-chevron-right" aria-hidden="true"></i></a></li>
                <li><a href="${pageContext.request.contextPath}/absence/querystudent">学生缺勤记录<i class="aa fa fa-chevron-right" aria-hidden="true"></i></a></li>
                <li><a href="${pageContext.request.contextPath}/absence/redo">学生补假<i class="aa fa fa-chevron-right" aria-hidden="true"></i></a></li>
                <li><a href="${pageContext.request.contextPath}/login/authority">用户权限管理<i class="aa fa fa-chevron-right" aria-hidden="true"></i></a></li>
