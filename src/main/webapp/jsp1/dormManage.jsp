    ...
    <div class="row-fluid">
        <div class="bs-docs-sidebar" >
            <ul class="bs-docs-sidenav">
                <li><a href="${pageContext.request.contextPath}/jsp1/dormManage.jsp">首页<i class="aa fa fa-chevron-right" aria-hidden="true"></i></a></li>
        ...
        <div class="span10" id="span10">
            <jsp:include page="${mainPage==null?'/jsp2/blank1.jsp':mainPage}"></jsp:include>
        </div>
    </div>
</div>
</body>
